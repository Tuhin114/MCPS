...
const features = [
  {
    icon: Cloud,
    title: "Secure Upload",
    description: "Drag and drop your files with instant encryption. Every upload is protected from the moment it leaves your device.",
  ...
  },
  {
    ...
    description: "Military-grade encryption protects your content at rest and in transit.",
  ...
  },
  {
    ...
    description: "Invisible or visible watermarks that survive compression and editing.",
  ...
  },
  {
    ...
    description: "Track file access, downloads, and sharing activity with detailed analytics and instant notifications.",
  ...
  },
  {
    ...
    description: "Granular permissions for teams, clients, and collaborators with time-based access.",
  ...
  },
  {
    ...
    description: "Comprehensive insights into your storage usage, file types, and optimization opportunities.",
          ...
          {feature.size === "large" && (
            <div className="mt-6 rounded-lg bg-muted/30 border border-border/30 p-4 opacity-60 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-8 rounded bg-muted/50 animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />
                ))}
              </div>
            </div>
          )}
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A comprehensive suite of tools designed for creators, agencies, and enterprises 
            who take content security seriously.
          </p>
        </motion.div>
